    ...
    public class GenericFilterService : IGenericFilterService
{
        ...
        where TEntity : class
    {
        ...
        {
            var predicates = w.Predicates ?? new List<CustomDataManagerRequest.WhereFilter>();
            var isComplex = predicates.Count > 0;
            ...
            return new Syncfusion.EJ2.Base.WhereFilter
            {
                ...
                predicates = isComplex
                    ? predicates.Select(p => new Syncfusion.EJ2.Base.WhereFilter
                    {
                        Field = p.Field,
                        Operator = p.Operator,
                        value = p.Value,
