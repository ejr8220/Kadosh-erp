...
namespace Kadosh_erp.Persistence
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<ContactFormPerson> ContactFormPersons => Set<ContactFormPerson>();
        public DbSet<User> Users => Set<User>();
        public DbSet<PasswordHistory> PasswordHistories => Set<PasswordHistory>();
        public DbSet<PasswordResetToken> PasswordResetTokens => Set<PasswordResetToken>();
        public DbSet<RefreshToken> RefreshTokens => Set<RefreshToken>();
        public DbSet<CompanyType> CompanyTypes => Set<CompanyType>();
        public DbSet<ParameterHeader> ParameterHeaders => Set<ParameterHeader>();
        public DbSet<ParameterDetail> ParameterDetails => Set<ParameterDetail>();
